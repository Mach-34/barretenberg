import { Halo2Wasm, Halo2WasmWorker } from '../halo2_wasm/halo2_wasm.js';
 ...
 */
export class Halo2Binder {
  constructor(public wasm: Halo2Wasm | Halo2WasmWorker) {}
...
export class Halo2BinderSync {
  constructor(public wasm: Halo2Wasm) {}
